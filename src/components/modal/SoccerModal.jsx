            ...
            <div className="relative bg-white rounded-lg shadow">
              ...
              <div className="p-4 sm:p-6 md:p-10 space-y-4">
                <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-700">
                  小学校から高校までは部活動で、大学ではサークルでサッカーを続けてきました。物心ついた時にはボールを蹴っていて、幼稚園の頃から休み時間にみんなでサッカーをしていました。その後、父の知り合いの影響で本格的にサッカーを習い始め、なんだかんだ楽しくて続けてきた結果、今では1番の趣味になりました。写真は高校最後の県総体の時のものです。
                </p>
              </div>
            </div>
          </div>
